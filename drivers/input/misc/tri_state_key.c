...
#define MODE_MUTE 600
#define MODE_DO_NOT_DISTURB 601
#define MODE_NORMAL 602

static int current_mode = 0;
static int keyCode_slider_top = MODE_MUTE;
static int keyCode_slider_middle = MODE_DO_NOT_DISTURB;
static int keyCode_slider_bottom = MODE_NORMAL;
...
static int tristate_dev_probe(struct platform_device *pdev)
{
	...
	//Init input device
        ...
        set_bit(MODE_MUTE, switch_data->input->keybit);
        set_bit(MODE_DO_NOT_DISTURB, switch_data->input->keybit);
        set_bit(MODE_NORMAL, switch_data->input->keybit);
